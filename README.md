...
|---------------------|---------------------|-------------------------------------|-----------------------|-----------------------------------------------|
| 2024年12月〜現在 | 4ヶ月 | 契約書管理クラウドサービスの開発 | SRE、フルスタックエンジニア | Ruby on Rails, Terraform, AWS, MySQL, Datadog |
| 2024年6月～2024年12月 | 7ヶ月 | eSIM開通アプリの開発               | モバイルエンジニア   | Flutter, Node, Typescript, Firebase                      |
| 2024年6月～現在      | 10ヶ月（在籍中） | 福利厚生提供アプリの開発           | フルスタックエンジニア | Flutter, Node, Ruby on Rails, MongoDB        |
| 2024年2月～現在      | 1年 2ヶ月（在籍中） | 医療機関の同意書管理システムの開発 | フルスタックエンジニア | React, Typescript, Flask, Laravel, MySQL                 |
| 2024年2月～2024年5月 | 3ヶ月               | Web3 Snap To Earnアプリの開発      | モバイルエンジニア   | Flutter, Python                              |
| 2023年6月～2024年6月 | 1年                 | LMSウェブアプリケーションの開発     | フルスタックエンジニア | Ruby on Rails, React, Terraform, MySQL       |
| 2023年6月～2023年9月 | 4ヶ月               | メンタルヘルスケアアプリの開発     | モバイルエンジニア   | Flutter, Python                              |
| 2022年12月～2023年7月 | 8ヶ月              | Android決済端末の新規プロダクト開発| リード・フルスタック | Kotlin, Java, Terraform, Ruby on Rails      |
| 2022年5月～2022年10月 | 6ヶ月              | 新決済方法導入コンサルティング     | PM                    | Kotlin, Java                                |
| 2021年7月～2023年7月 | 2年                 | Android決済端末の決済アプリ開発    | モバイルエンジニア   | Kotlin, Java                                 |
| 2021年7月～2023年7月 | 2年                 | キャッシュレス決済モバイルアプリ   | モバイルエンジニア   | Kotlin, Java, Swift, Objective-C            |
| 2021年3月～2021年8月 | 6ヶ月               | 英語学習アプリの開発               | モバイルエンジニア   | Flutter, Python                             |
| 2020年8月～2023年8月 | 3年                 | 生活改善系アプリの開発             | モバイルエンジニア   | Swift, Kotlin, Flutter                      |
...
| **Monitoring Tool**      | Datadog, Sentry, OpsRamp, Firebase Analytics                                                                   |
...
- **役割**: SRE、フルスタックエンジニア
- **業務内容**:
  - Terraformでのインフラ管理、追加機能実装時のインフラリソース追加
  - Datadogの管理、運用
  - バックエンドの追加機能実装、不具合修正
- **使用技術**: Ruby on Rails, Terraform, AWS, MySQL, Datadog
- **その他ツール**: Slack, Notion, Asana

### eSIM開通アプリの開発（フリーランス）
- **期間**: 2024年6月～2024年12月
- **役割**: モバイルエンジニア
- **業務内容**:
  - eSIMをスマートフォンで使用するためのeSIM開通アプリの開発
  - 状態管理をRiverpodに移行し、アーキテクチャの整備とフルリファクタリング
  - e2eテスト導入
  - 既存バグの修正、UIの変更
  - BFFに監視ツールOpsRampの導入
- **使用技術**: Flutter, Node, Firebase
- **その他ツール**: CodeCommit, Slack, Jira
...
- **業務内容**:
  - フロントエンド開発（React）
  - バックエンド開発（Flask, Laravel）
  - ReactQuillを使用したエディタの開発
- **使用技術**: React, Flask, Laravel, MySQL
- **その他ツール**: GitHub, Slack, Backlog, ClickUp

### Web3 Snap To Earnアプリの開発（フリーランス）
- **期間**: 2024年2月～2024年5月
- **役割**: モバイルエンジニア
- **業務内容**:
  - フロントエンド開発（Flutter）
  - ProviderからRiverpodへの移行リファクタリング
- **使用技術**: Flutter, Python
- **その他ツール**: GitHub, Slack, GCP, Alchemy, Cloud Functions

### LMSウェブアプリケーションのフルスタック開発（正社員）
- **期間**: 2023年6月～2024年6月
- **役割**: フルスタックエンジニア
- **業務内容**:
  ...
  - 既存システムとの連携キーを使用したデータ連携構築
- **使用技術**: Ruby on Rails, React, Terraform, MySQL
- **その他ツール**: CircleCI, Slack, Datadog, Sentry, AWS, Docker, Miro

### メンタルヘルスケアアプリの開発（フリーランス）
- **期間**: 2023年6月～2023年9月
- **役割**: モバイルエンジニア
- **業務内容**:
  - FlutterとFirebaseを使用したメンタルヘルスケアアプリの開発
  - Firebase Authenticationsを使用したログイン機能開発
  - Firestore DB設計およびセキュリティルール構築
- **使用技術**: Flutter, Python
- **その他ツール**: GitHub, Slack, Miro, Cloud Functions

### Android決済端末上の新規プロダクトの開発（正社員）
- **期間**: 2022年12月～2023年7月
- **役割**: リード、フルスタックエンジニア
- **業務内容**:
  - Android端末をサーバー化し、他端末からのリクエストを受け付ける中継アプリの開発
  - NFC FeliCaを使用するためのFeliCaモジュールの開発
- **使用技術**: Kotlin, Java, Terraform, Ruby on Rails
- **その他ツール**: GitLab, draw.io, AWS, Docker

### 新決済方法導入コンサルティング（正社員）
- **期間**: 2022年5月～2022年10月
- **役割**: PM
- **業務内容**:
  - 他事業者への新たな決済方法導入に関するコンサルティング
  - プロジェクトのスケジュール管理およびソースコードの提供
  - 不具合の修正
- **使用技術**: Kotlin, Java

### Android決済端末上の決済アプリ開発（正社員）
- **期間**: 2021年7月～2023年7月
- **役割**: モバイルエンジニア
- **業務内容**:
  - Android端末上で動作するキャッシュレス決済アプリの開発
  - 電子マネー機能やQR決済機能の追加
  - 仕様書ドキュメントの作成
  - 不具合修正、コードレビュー
- **使用技術**: Kotlin, Java
...
- **業務内容**:
  - 音読練習特化型の英語学習アプリの開発
  - 生徒と先生のチャット機能、ログイン機能の実装
  - Speech To Text、Text To Speechを使用した機能開発
- **使用技術**: Flutter, Python
- **その他ツール**: Firebase Authentication, Firestore, Cloud Functions, Firebase Cloud Messaging

### 生活改善系アプリの開発（フリーランス）
- **期間**: 2020年8月～2023年8月
- **役割**: モバイルエンジニア
- **業務内容**:
  - 生活改善（習慣化、集中力強化、睡眠改善等）をサポートするアプリの開発
  - 機能追加、不具合修正
  - BitriseとDeployGateを使用したCDの自動化
  - Firebase AB Testingを使用したユーザーデータ分析
- **使用技術**: Swift, Kotlin, Flutter
- **その他ツール**: Firebase Event, Firebase Crashlytics
...
### Full-Stack Development of an LMS Web Application (Full-Time)
...
### Development of a Cashless Payment Mobile App (Full-Time)
- **Period**: Jul 2021 – Jul 2023
- **Role**: Mobile Engineer
- **Responsibilities**:
